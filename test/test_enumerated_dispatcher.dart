...
final Logger _logger = new Logger('test_enumerated_dispatcher');
...
// Ensure size of discriminator is at least as large as 3 for "125"
...
std::string const& discriminator_{discriminator};
size_t discriminator_length_{discriminator_.length()};
// Ensure size of discriminator is at least as large as 1 for "1"
if (1 > discriminator_length_) return;
if ('1' == discriminator_[0]) {
  // Ensure size of discriminator is at least as large as 2 for "13"
  ...
  if ('2' == discriminator_[1]) {
    // Ensure size of discriminator is at least as large as 3 for "124"
    ...
    if ('5' == discriminator_[2]) {
      ...
      // Ensure size of discriminator is at least as large as 4 for "1258"
...
// Ensure size of discriminator is at least as large as 2 for "32"
if (2 > discriminator_length_) return;
...
// Ensure size of discriminator is at least as large as 3 for "256"
if (3 > discriminator_length_) return;
if (strncmp("256", &discriminator_[0], 3) == 0) {
  ...
  // Ensure size of discriminator is at least as large as 4 for "2568"
  if (4 > discriminator_length_) return;
  if ('8' == discriminator_[3]) {
