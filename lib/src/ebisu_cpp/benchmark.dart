...
class BenchmarkApp extends Impl implements CodeGenerator {
  ...
  get cppPath => this.installation.cppPath;
...
class Benchmark extends CppEntity {
  ...
  BenchmarkApp get benchmarkApp => _benchmarkApp;
...
'''));
  ...
  _makeStandAloneApp() => new BenchmarkApp(id.snake)
    ..namespace = _namespace
...
BenchmarkApp benchmarkApp(id) => new BenchmarkApp(id);
